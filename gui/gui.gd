...
const human_sprite = [
	preload("res://gui/human_bar_0.tres"),
	preload("res://gui/human_bar_1.tres"),
	preload("res://gui/human_bar_2.tres"),
	preload("res://gui/human_bar_3.tres"),
	preload("res://gui/human_bar_4.tres"),
]
